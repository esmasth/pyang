...
def stmt_ref_lenses(uri: str, ctx: Context, stmt: Statement):
    ...
    for substmt in stmt.substmts:
        lenses.extend(stmt_ref_lenses(uri, ctx, substmt))
...
def text_document_code_lens(
    ...
    return stmt_ref_lenses(params.text_document.uri, wfc.ctx, module)
